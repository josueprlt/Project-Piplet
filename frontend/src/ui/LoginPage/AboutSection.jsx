    ...
    <section id="about-section" ref={aboutSectionRef}>
      ...
      <div id="wrapper">
        <div className="container px-5">
          <button id="back-btn" onClick={toggleAbout}><BsArrowLeft /></button>
          <div className="row pt-5 pt-lg-4 pt-xxl-3 content-about justify-content-center">
            <div className="col-12 col-md-8 col-lg-6 fs-6">
              ...
              <div className="row mt-5">
                <div className="col-12 text-end cta-desktop">
                  <button className="btn btn-dark close-about" onClick={toggleAbout}>Fermer</button>
                </div>
              </div>
            </div>
          </div>
